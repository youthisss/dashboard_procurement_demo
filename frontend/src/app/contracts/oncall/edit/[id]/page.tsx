...
export default function OncallEdit() {
    ...
    <div className="dashboard-page-form">
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 16, flexWrap: 'wrap', marginBottom: 12 }}>
        <Space>
          ...
          <Typography.Title level={2} style={{ margin: 0, fontWeight: 700 }}>Edit Oncall Routing</Typography.Title>
        </Space>
        <ContractModeSwitch />
      </div>
      ...
      <Row gutter={[24, 24]} align="stretch" justify="center">
        ...
        <Col xs={24} lg={10}>
          <AgreementHistoryPanel
            ...
            resourceSuffix="oncall"
            entityTypeDb="contract_oncall"
          />
        </Col>
      </Row>
    </div>
