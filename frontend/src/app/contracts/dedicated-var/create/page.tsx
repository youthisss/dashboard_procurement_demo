...
export default function DedicatedVarCreate() {
  ...
  const handleOnFinish = async (values: any) => {
    ...
    ['distance', 'payload', 'cost_idr', 'cost_per_kg', 'cost_per_kg_km'].forEach(key => {
    ...
    <div className="dashboard-page-form">
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: 12, justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        <Space>
          ...
          <Typography.Title level={2} style={{ margin: 0, fontWeight: 700 }}>Create Dedicated Var Contract</Typography.Title>
        </Space>
        <ContractModeSwitch />
      </div>
